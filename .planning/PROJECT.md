...
- [ ] **去中心化劇本市集與結構 (Scenario & Marketplace)**:
  - 劇本以「共享物件 (Shared Object)」形式發布，包含名稱、背景設定、簡介、入場人數限制與指定質押金額。
  - 開放玩家/KP 自由創作劇本，並提供官方單人無 KP 劇本做為引導入門。
  - KP 可自定義劇本細節，如有惡意哄抬，玩家可發動脫出並檢舉。
